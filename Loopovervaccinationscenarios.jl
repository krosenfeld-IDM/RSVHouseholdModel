...
sol_repvac = solve(RepeatedForecasts,trajectories = 500,CVODE_BDF(linear_solver=:GMRES),abstol = 1e-3,reltol = 1e-3)
# @save "./NEW_DATA/HH_inf_baseline_R_$(SchoolsOnlyR_0).jld" sol_repvac.u

# # @save "Baseline_incidence.jld" sol_repvac.u
# # tot = [sum(sol_repvac.u[i][end]) for i =1:500]

# @everywhere MABCoverage = 1.
...
# @save "./NEW_DATA/solid_prot_inf_$(CurrentSolidProtectionDuration)_HHCov_$(HHCoverage)_MABCov_$(MABCoverage)_R_$(SchoolsOnlyR_0).jld" sol_repvac.u

# @everywhere CurrentSolidProtectionDuration = 30.
# sol_repvac = solve(RepeatedForecasts,num_monte = 500,CVODE_BDF(linear_solver=:GMRES),abstol = 1e-3,reltol = 1e-3)
# @save "./DATA/solid_prot_inf_$(CurrentSolidProtectionDuration)_HHCov_$(HHCoverage)_MABCov_$(MABCoverage)_R_$(SchoolsOnlyR_0).jld" sol_repvac.u
...
# # sol_repvac = solve(RepeatedForecasts,num_monte = 500,CVODE_BDF(linear_solver=:GMRES),abstol = 1e-3,reltol = 1e-3)
# # @save "solid_prot_inf_$(CurrentSolidProtectionDuration)_HHCov_$(HHCoverage)_MABCov_$(MABCoverage)_R_$(SchoolsOnlyR_0).jld" sol_repvac.u
# # gr()
...
# #
# # solid_30 = load("solid_prot_inf_30.0_HHCov_$(HHCoverage)_MABCov_$(MABCoverage)_R_$(SchoolsOnlyR_0).jld")["sol_repvac.u"]
...
# #
# # solid_90 = load("./DATA/solid_prot_inf_90.0_HHCov_$(HHCoverage)_MABCov_$(MABCoverage)_R_$(SchoolsOnlyR_0).jld")["sol_repvac.u"]
...
# # hh_vac_mean = mean([sum(sol_repvac.u[i][end]) for i = 1:10])
# # title!("HH vaccination: Mean imp. = $(100*(BaseMean - hh_vac_mean)/BaseMean)%")
# #
...
# # sol_repvac = solve(RepeatedForecasts,num_monte = 500,CVODE_BDF(linear_solver=:GMRES),abstol = 1e-3,reltol = 1e-3)
# # @save "./DATA/mean_prot_inf_$((1/P_ModelParams.α) - FittedMeanDuration)_HHCov_$(HHCoverage)_MABCov_$(MABCoverage)_R_$(SchoolsOnlyR_0).jld" sol_repvac.u
# #
...
# @everywhere P_ModelParams.α = 1/(FittedMeanDuration)
# sol_repvac = solve(RepeatedForecasts,num_monte = 500,CVODE_BDF(linear_solver=:GMRES),abstol = 1e-3,reltol = 1e-3)
# @save "./DATA/solid_prot_inf_$(CurrentSolidProtectionDuration)_HHCov_$(HHCoverage)_MABCov_$(MABCoverage)_R_$(SchoolsOnlyR_0)_finer_DT.jld" sol_repvac.u
